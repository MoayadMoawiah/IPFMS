...
let UsersController = class UsersController {
    ...
    remove(id, user) { return this.svc.softDelete(id, user.id); }
    activate(id) { return this.svc.activate(id); }
    deactivate(id) { return this.svc.deactivate(id); }
    getPermissions(id) { return this.svc.getUserPermissions(id); }
    assignRole(id, body, user) { return this.svc.assignRole(id, body.roleId, user.id); }
    removeRole(id, roleId) { return this.svc.removeRole(id, roleId); }
};
