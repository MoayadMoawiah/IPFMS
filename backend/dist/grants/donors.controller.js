...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new donor' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('GRANTS:READ'),
    (0, swagger_1.ApiOperation)({ summary: 'Get donor detail with grants' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update donor' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('DONORS:DELETE'),
    (0, common_1.HttpCode)(common_1.HttpStatus.NO_CONTENT),
    (0, swagger_1.ApiOperation)({ summary: 'Soft delete donor' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
