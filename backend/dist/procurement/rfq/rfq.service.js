    ...
    async updateVendorQuotation(rfqId, rfqVendorId, dto) {
        return this.prisma.rfqVendor.update({
            ...
            data: {
                ...
                technicalScore: dto.technicalScore ? new client_1.Prisma.Decimal(dto.technicalScore) : undefined,
                committeeScore: dto.committeeScore ? new client_1.Prisma.Decimal(dto.committeeScore) : undefined,
                notes: dto.notes,
            },
        });
    }
