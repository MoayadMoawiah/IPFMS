...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('WORKFLOW:APPROVE'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", void 0)
], PurchaseOrdersController.prototype, "return_", null);
__decorate([
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('PURCHASE_ORDERS:UPDATE'),
    (0, swagger_1.ApiOperation)({ summary: 'Upload documents to a purchase order' }),
    ...
    __metadata("design:returntype", void 0)
], PurchaseOrdersController.prototype, "uploadDocuments", null);
__decorate([
    (0, common_1.Get)(':id/documents'),
    (0, permissions_decorator_1.RequirePermissions)('PURCHASE_ORDERS:READ'),
    (0, swagger_1.ApiOperation)({ summary: 'List documents attached to a purchase order' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PurchaseOrdersController.prototype, "listDocuments", null);
__decorate([
    (0, common_1.Delete)(':id/documents/:attachmentId'),
    (0, permissions_decorator_1.RequirePermissions)('PURCHASE_ORDERS:UPDATE'),
    (0, common_1.HttpCode)(common_1.HttpStatus.NO_CONTENT),
    (0, swagger_1.ApiOperation)({ summary: 'Remove a document from a purchase order' }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], PurchaseOrdersController.prototype, "deleteDocument", null);
__decorate([
