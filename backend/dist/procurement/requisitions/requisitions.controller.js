...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)('PROCUREMENT:CREATE'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('PROCUREMENT:UPDATE'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('PROCUREMENT:DELETE'),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('PROCUREMENT:SUBMIT'),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('PROCUREMENT:APPROVE'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
