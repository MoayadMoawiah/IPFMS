...
let AuditController = class AuditController {
    ...
    findAll(userId, module, resource, action, startDate, endDate, page, limit) {
...
__decorate([
    (0, common_1.Get)(':documentType/:documentId'),
    (0, permissions_decorator_1.RequirePermissions)('AUDIT:READ'),
    (0, swagger_1.ApiOperation)({ summary: 'Get audit trail for a specific document' }),
    __param(0, (0, common_1.Param)('documentType')),
    __param(1, (0, common_1.Param)('documentId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], AuditController.prototype, "findByDocument", null);
