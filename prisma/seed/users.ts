...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  'role-finance-manager': [
    ...
    'PAYMENTS:CREATE', 'PAYMENTS:READ', 'PAYMENTS:APPROVE', 'PAYMENTS:PAY',
  ...
  'role-finance-officer': [
    ...
    'PROJECTS:READ', 'ACTIVITIES:READ',
    'PROCUREMENT:READ',
    'PURCHASE_ORDERS:READ', 'PURCHASE_REQUISITIONS:READ',
  ...
  'role-procurement-manager': [
    ...
    'PURCHASE_REQUISITIONS:READ', 'PURCHASE_REQUISITIONS:APPROVE',
    'PURCHASE_ORDERS:CREATE', 'PURCHASE_ORDERS:READ', 'PURCHASE_ORDERS:UPDATE', 'PURCHASE_ORDERS:APPROVE', 'PURCHASE_ORDERS:ISSUE',
    'GOODS_RECEIPTS:CREATE', 'GOODS_RECEIPTS:READ', 'GOODS_RECEIPTS:APPROVE',
    'CONTRACTS:CREATE', 'CONTRACTS:READ', 'CONTRACTS:UPDATE', 'CONTRACTS:APPROVE',
    'RFQ:CREATE', 'RFQ:READ', 'RFQ:UPDATE', 'RFQ:EVALUATE',
    'INVENTORY:READ',
    'WORKFLOW:READ', 'WORKFLOW:APPROVE',
    'REPORTS:READ',
  ],
  'role-procurement-officer': [
    ...
    'VENDORS:READ',
    'PURCHASE_REQUISITIONS:CREATE', 'PURCHASE_REQUISITIONS:READ', 'PURCHASE_REQUISITIONS:UPDATE', 'PURCHASE_REQUISITIONS:SUBMIT',
