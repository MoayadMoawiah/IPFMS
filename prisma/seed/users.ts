...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  'role-finance-manager': [
    ...
    'PAYMENTS:CREATE', 'PAYMENTS:READ', 'PAYMENTS:SUBMIT', 'PAYMENTS:APPROVE', 'PAYMENTS:PAY',
  ...
  'role-finance-officer': [
    ...
    'PAYMENTS:CREATE', 'PAYMENTS:READ', 'PAYMENTS:SUBMIT',
    'CHART_OF_ACCOUNTS:READ',
  ...
  'role-procurement-manager': [
    ...
    'GOODS_RECEIPTS:CREATE', 'GOODS_RECEIPTS:READ', 'GOODS_RECEIPTS:SUBMIT', 'GOODS_RECEIPTS:APPROVE',
  ...
  'role-warehouse-manager': [
    ...
    'GOODS_RECEIPTS:CREATE', 'GOODS_RECEIPTS:READ', 'GOODS_RECEIPTS:SUBMIT',
    'PURCHASE_ORDERS:READ',
    'RFQ:READ',
    'WORKFLOW:READ',
  ],
